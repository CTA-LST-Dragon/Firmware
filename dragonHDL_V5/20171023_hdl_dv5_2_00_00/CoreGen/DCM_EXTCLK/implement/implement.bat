...
xst -ifn xst.scr
move DCM_EXTCLK_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DCM_EXTCLK_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCM_EXTCLK_exdes.ucf DCM_EXTCLK_exdes

echo 'Running map'
map -timing -pr b DCM_EXTCLK_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm DCM_EXTCLK_exdes -w routed.ncd routed.v
cd ..
