...
vlog -work work DCM_V5_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax DCM_V5_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.DCM_V5_tb work.glbl
