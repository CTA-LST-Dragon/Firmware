...
xst -ifn xst.scr
move DCM_GMII_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DCM_GMII_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCM_GMII_exdes.ucf DCM_GMII_exdes

echo 'Running map'
map -timing -pr b DCM_GMII_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm DCM_GMII_exdes -w routed.ncd routed.v
cd ..
