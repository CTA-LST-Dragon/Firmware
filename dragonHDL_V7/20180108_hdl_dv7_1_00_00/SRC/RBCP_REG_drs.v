...
module RBCP_REG_drs(
	...
	X00Data,    //FIRMWARE_VER
	X01Data, 
	X02Data,    //FIRMWARE_SUBVER
	X03Data,    //DIP_SWITCH_READ
	X04Data,    //DEBUG_IN
	X05Data, 
	X06Data,
	X07Data,
	X08Data, 	// data in rbcp register(command_rst)
	X09Data,    //DUBUG_PARAM
	X0AData,
	X0BData,    //TRIGGER_SELECT
	X0CData,    //TRIGGER_FREQ
	X0DData,    
	X0EData,    
	X0FData,

	X10Data,    //command_adcspi
	X11Data,    //ADC_SPI_DATA
	X12Data,    //ADC_SPI_ADDR
	X13Data,
	X14Data,    //Reserved
	X15Data,
	X16Data,
	...
	X1CData,
	X1DData,
	X1EData,    //TRIGGER_ENABLE
	X1FData,    //BUSY_STATE

	X20Data,    //command_dtrigset
	X21Data,    //DTRIG_THRESHOLD_x
	X22Data,
	X23Data,
	X24Data,
	X25Data,
	...
	X40Data,    //command_l0_sc_write
	X41Data,    //command_l0_sc_read
	X42Data,    //command_l0_reset
	X43Data,    //command_l0dela_set
	X44Data,    //command_l0dela_reset
	X45Data,    //command_l1_sc_write
	X46Data,    //command_l1_sc_read
	X47Data,    //command_l1_read
	X48Data,    //RATE_WINDOWL1
	X49Data,    
	X4AData,    //RATE_L1OUT(Dragon_ver5)
	X4BData,    
	X4CData,    //RATE_L1OUT2
	X4DData,    
	X4EData,    //RATE_TRIGL1
	...
	X50Data,    //L0_SC_ADDRESS
	X51Data,    //L0_SC_DATA
	X52Data,    
	X53Data,    //L1_SC_READ
	X54Data,
	X55Data,
	X56Data,    //L1_SC_ADDRESS
	X57Data,    //L1_SC_DATA
	X58Data,
	X59Data,    //L1_SC_READ
	X5AData,
	X5BData,
	X5CData,    //L0_DELAYEXPAND_DATA
	X5DData,
	X5EData,
	X5FData,    //Reserved

	X60Data,    //command_bp_sc_write
	X61Data,    //BP_SC_SEND_DATA
	X62Data,
	X63Data,
	X64Data,
	X65Data,    //BP_SC_READ
	...
	X67Data,
	X68Data,
	X69Data,    //command_bp_fpgaprogram
	X6AData,    //Reserved
	X6BData,
	X6CData,
	X6DData,
	...
	X70Data,    //command_sramwrite
	X71Data,    //command_sramread
	X72Data,    //command_sramzz
	X73Data,    //SRAM_ADDR
	X74Data,
	X75Data,
	X76Data,    //SRAM_WRITEDATA
	X77Data,
	X78Data,
	X79Data,
	X7AData,    //SRAM_WRITEDATAP
	X7BData,    //SRAM_READDATA
	X7CData,
	X7DData,
	X7EData,
	X7FData,    //SRAM_READDATAP
	
	X80Data,    //command_dacset
	X81Data,    //DAC_ROFS
	X82Data,
	X83Data,    //DAC_OOFS
	X84Data,
	...
	X8CData,
	X8DData,
	X8EData,    //DRS_DRITE_TO_READY
	X8FData,    

	X90Data,    //DRS_READDEPTH
	X91Data,
	X92Data,    //DRS_STOP_FROM_TRIG
	X93Data,
	X94Data,    //DRS_SAMP_FREQ
	X95Data,    //DRS_READ_FROM_STOP
	X96Data,
	X97Data,
	X98Data,
	X99Data,    //DRS_CLKOPUT_ENABLE
	X9AData,    //DRS_PLLLCK_CHECK
	X9BData,    //DRS_CALREAD
	X9CData,    //DRS_CASCADENUM
	X9DData,    //DRS_REFCLK_RESET
	X9EData,    //DRS_REFCLK_SELECT
	X9FData,    //DRS_TIME_CAL
	
	XA0Data,    //command_scb_spisend
	XA1Data,    //command_tp_trig
	XA2Data,    //Reserved
	XA3Data,
	XA4Data,
	XA5Data,    //SCB_SPICMD
	...
	XC5Data,
	XC6Data,
	XC7Data,    //SCB_TP_TRIG_FREQ
	XC8Data,
	XC9Data,
	XCAData,
	XCBData,    //SCB_TP_TRIG_WIDTH
	XCCData,
	XCDData,    //TRIGGER_FREQ_OFFSET
	XCEData,
	XCFData,    //SCB_TP_CLKSELECT
	
	XD0Data,    //i2c_set
	XD1Data,    //I2C_ADDR	
	XD2Data,    //I2C_CMD
	XD3Data,    //I2C_WRITEDATA
	XD4Data,    //I2C_READDATA
	XD5Data
);
...
//--------------------------------------
	...
	assign XD0Data[7:0] = regXD0Data[7:0];
	assign XD1Data[7:0] = regXD1Data[7:0];
	assign XD2Data[7:0] = regXD2Data[7:0];
	assign XD3Data[7:0] = regXD3Data[7:0];
	//assign XD4Data[7:0] = regXD4Data[7:0];
	//assign XD5Data[7:0] = regXD5Data[7:0];
...
//--------------------------------------
	...
	always@ (posedge CLK) begin
		case(regAddr[7:0])
			...
			8'hD0:   muxRegDataA[7:0] <= XD0Data[7:0];
			8'hD1:   muxRegDataA[7:0] <= XD1Data[7:0];
			8'hD2:   muxRegDataA[7:0] <= XD2Data[7:0];
			8'hD3:   muxRegDataA[7:0] <= XD3Data[7:0];
			8'hD4:   muxRegDataA[7:0] <= XD4Data[7:0];
			8'hD5:   muxRegDataA[7:0] <= XD5Data[7:0];
